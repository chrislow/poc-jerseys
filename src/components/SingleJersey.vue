...
<template>
    <div class="block h-[200px] w-[200px]">
        <svg viewBox="0 0 656 656" class="absolute h-[200px]">
            <!-- Vorderseite Hintergrund = base -->
            <path :fill="$props.base"
            ...
            <!-- Nacken = sleeve -->
            <path :fill="$props.sleeve" fill-rule="evenodd"
            ...
            <!-- Vorderseite Streifen (vertical) = stripes -->
            <path v-if="$props.stripes" :fill="$props.stripes" d="M292.1 648.8c-15.7-1.4-37.7-5-49.7-7.1-4.3-.6-22.6-5.3-35.5-9.5 1.5-10 3-21 4.3-32.7     7-60.54.8-132.8 3.1-185.6l-.9-32c-1-49-2.4-83.5-3.6-112-1.2-29-2.1-51.7-2.1-77 0-29 2.9-77.3
            ...
            <!-- Vorderseite Streifen (horizontal) = horizontalstripes -->
            <path v-if="$props.horizontalstripes" :fill="$props.horizontalstripes" d="M507.8 187.7c-1.5 2-3 3.9-3.9 4.8-1.2-.3-5.6 4.4-7.6 6.7.4 2 .6 6.7-1.4 9.1-2 2.5-1.7 6.9-1.3
    ...
    35.5-14.3a61 61 0 0 0 4.7-3c1.5-1.1 4.3-4 4-7Z">
        ...
        <img src="../assets/images/jerseys/overlay.png" alt="overlay" class="absolute h-[200px]">
    </div>
    <!-- <p class="greeting">{{ $props }}</p> -->
</template>
